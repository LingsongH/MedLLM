...
def main():
    ...
    # 使用 parse_args_into_dataclasses 时忽略未知参�?    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        # 如果我们传递了一�?JSON 文件，让我们用它来配置参�?        model_args, data_args, training_args, script_args = parser.parse_json_file(
